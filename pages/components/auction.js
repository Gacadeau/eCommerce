            ...
            <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                        ...
                        {products[currentImageIndex] && (
                            ...
                            <div className="px-5 pb-5">
                                ...
                                <div className="flex items-center justify-between">
                                        {products[currentImageIndex] && (
                                        <span className="text-3xl font-bold text-gray-900 dark:text-white">${products[currentImageIndex].unit_price}</span>
                                        )}
                                        <button 
                ...
                <div key={index} onClick={() => handleBuyClick(product)}  className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    ...
                    <div className="pt-3 flex items-center justify-between">
                        ...
                        <button onClick={() => handleBuyClick(product)} className="bg-yellow-500 hover:bg-yellow-700 text-white font-semibold py-2 px-4">
                            Submit a bid
                        </button>
                    </div>
                    <p className="pt-1 text-gray-900">Open Price : <span className='font-semibold text-md bg-red-500 p-1'>${product.open_price}</span></p>
                    <p className="pt-1 text-gray-900">Actual Price : <span className='font-semibold text-2xl'>${product.unit_price}</span></p>
                    <p className="pt-1 text-gray-900">2D12H:12M:12s</p>
