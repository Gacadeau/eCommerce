...
//   // Générer le fichier PDF à partir du contenu de la page
...
const downloadPageAsPDF = () => {
  ...
  let y = 30;
  carts.forEach((cart) => {
    doc.text(`${cart.n_product} - Qty: ${cart.qte} - Unit Price: $${cart.unit_price} - Subtotal: $${cart.total}`, 10, y);
    y += 10;
  });

  // Ajouter la date de la facture
  doc.text(`Invoice generated on ${currentDate} ${currentTime}`, 10, y + 10);
  ...
  return (
    <div class="bg-gray-200 print:bg-white md:flex lg:flex xl:flex print:flex md:justify-center lg:justify-center xl:justify-center print:justify-center sf">
