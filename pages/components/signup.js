...
<div className="h-screen flex">
          ...
          justify-around items-center">
            ...
            <div className="w-full mx-auto px-20 flex-col items-center space-y-6">
              ...
              <p className="text-white font-semibold mt-1">create your account?</p>
          ...
          <div className="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
            ...
            <form className="bg-white rounded-md shadow-2xl p-5">
              ...
              <button type="submit" className="block w-full bg-yellow-600 mt-5 py-2 rounded-md hover:bg-yellow-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Signup</button>
              <div className="flex justify-between mt-4">

                <a href="#" className="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all"> have an account</a>
              </div>
